...
{
	public class StringResXFileCodeGenerator : MonoDevelop.Ide.CustomTools.ISingleFileCustomTool
	{
		public static void GenerateDesignerFile(string resxfile, string @namespace, string classname, string designerfile)
		{
			...
			var filetemplate = new StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("StringResxDesignerGenerator.HeaderTemplate.txt")).ReadToEnd();
			var elementtemplate = new StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("StringResxDesignerGenerator.ElementTemplate.txt")).ReadToEnd();
